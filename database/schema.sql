...
CREATE TABLE students (
    ...
    name VARCHAR(255) NOT NULL,
    phone VARCHAR(20) NOT NULL,
    enroll_limit INT NOT NULL DEFAULT 5,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
CREATE TABLE enrollments (
    ...
    CONSTRAINT fk_en_student FOREIGN KEY (student_id)
...
('CSE101', 'Dasar Pemrograman', 'Pengenalan dasar logika & sintaks.', 'Programming', 30, 0, 'published'),
('CSE201', 'OOP dengan PHP', 'Konsep OOP dan praktik REST API.', 'Programming', 25, 0, 'published'),
('CSE301', 'Design Patterns', 'Pengenalan design pattern umum.', 'Programming', 20, 0, 'draft'),
('CSE401', 'Software Architecture', 'Arsitektur perangkat lunak modern.', 'Software Engineering', 20, 0, 'published');
